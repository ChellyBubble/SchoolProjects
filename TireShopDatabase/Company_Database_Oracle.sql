...
set echo on
/
DROP TABLE A_EMPLOYEE CASCADE CONSTRAINTS;
DROP TABLE A_DEPARTMENT CASCADE CONSTRAINTS;
DROP TABLE A_DEPT_LOCATIONS CASCADE CONSTRAINTS;
DROP TABLE A_PROJECT CASCADE CONSTRAINTS;
DROP TABLE A_WORKS_ON CASCADE CONSTRAINTS;
DROP TABLE A_DEPENDENT CASCADE CONSTRAINTS;
