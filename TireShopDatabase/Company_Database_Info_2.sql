...
INSERT INTO A_WORKS_ON 
	values ("123456789",1,32.5, true);
INSERT INTO A_WORKS_ON 
	values ("123456789",2,7.5, true);
INSERT INTO A_WORKS_ON 
	values ("666884444",3,40.0, true);
INSERT INTO A_WORKS_ON 
	values ("453453453",1,20.0, true);
INSERT INTO A_WORKS_ON 
	values ("453453453",2,20.0, true);
INSERT INTO A_WORKS_ON 
	values ("333445555",2,10.0, true);
INSERT INTO A_WORKS_ON 
	values ("333445555",3,10.0, true);
INSERT INTO A_WORKS_ON 
	values ("333445555",10,10.0, true);
INSERT INTO A_WORKS_ON 
	values ("333445555",20,10.0, true);
INSERT INTO A_WORKS_ON 
	values ("999887777",30,30.0, true);
INSERT INTO A_WORKS_ON 
	values ("999887777",10,10.0, true);
INSERT INTO A_WORKS_ON 
	values ("987987987",10,30.0, true);
INSERT INTO A_WORKS_ON 
	values ("987987987",30,5.0, true);
INSERT INTO A_WORKS_ON 
	values ("987654321",30,20.0, true);
INSERT INTO A_WORKS_ON 
	values ("987654321",20,15.0, true);
INSERT INTO A_WORKS_ON 
	values ("888665555",20,null, true);
